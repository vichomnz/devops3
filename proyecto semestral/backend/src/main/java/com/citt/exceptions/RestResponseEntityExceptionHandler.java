...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleDespachoNotFound(DespachoNotFoundException exception) {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<ErrorMessage> handleVentaNotFound(VentaNotFoundException exception) {
